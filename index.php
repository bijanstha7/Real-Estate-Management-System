                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Selling
                                            Service</a></h5>
                                    <p>"You can advertise your real estate properties on different categories like
                                        'house
                                        for sale', 'land or jagga or sale'
                                        very easily and in economic way."</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Rental
                                            Service</a></h5>
                                    <p>"You can advertise your real estate properties on different categories like
                                        'house, apartment, flat or land for rent', very easily and in economic way."</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Property
                                            Listing</a></h5>
                                    <p>"Advertise your property to millions of customers and instantly get the right
                                        price for your property."</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                ...
                                <ul>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>"Top one private limited company in Nepal".</p>
                                        </div>
                                    </li>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>"Sells over 100+ properties with great Experience and Good Feedback."</p>
                                        </div>
                                    </li>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>"More than 5 years+ experience agents which provide Good Property."</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <p>"Direct Discuss with Property Owner."</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    ...
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $query = mysqli_query($con, "SELECT count(state), property.* FROM property where city='Gorkha'");
                                        while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                        <h4 class="hover-text-success text-capitalize"><a
                                                href="stateproperty.php?id=<?php echo $row['17'] ?>"><?php echo $row['state']; ?></a>
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    ...
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $query = mysqli_query($con, "SELECT count(state), property.* FROM property where city='Dhankuta'");
                                        while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                        <h4 class="hover-text-success text-capitalize"><a
                                                href="stateproperty.php?id=<?php echo $row['17'] ?>"><?php echo $row['state']; ?></a>
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    ...
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $query = mysqli_query($con, "SELECT count(state), property.* FROM property where city='Dhading'");
                                        while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                        <h4 class="hover-text-success text-capitalize"><a
                                                href="stateproperty.php?id=<?php echo $row['17'] ?>"><?php echo $row['state']; ?></a>
